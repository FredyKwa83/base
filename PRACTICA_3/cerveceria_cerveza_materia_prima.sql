...
CREATE TABLE `cerveza_materia_prima` (
  ...
  `cerveza_id` int DEFAULT NULL,
  `materia_prima_id` int DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `cerveza_id` (`cerveza_id`),
  KEY `materia_prima_id` (`materia_prima_id`),
  CONSTRAINT `cerveza_materia_prima_ibfk_1` FOREIGN KEY (`cerveza_id`) REFERENCES `cerveza` (`id`),
  CONSTRAINT `cerveza_materia_prima_ibfk_2` FOREIGN KEY (`materia_prima_id`) REFERENCES `materia_prima` (`id`)
...
INSERT INTO `cerveza_materia_prima` VALUES (1,'300','ml',1,1),(2,'1','gr',1,2),(3,'0.5','gr',1,3),(4,'0.7','gr',1,4),(5,'0.3','gr',1,5);
