...
CREATE TABLE `tipo_categoria` (
  ...
  CONSTRAINT `tipo_categoria_ibfk_1` FOREIGN KEY (`tipo_id`) REFERENCES `tipo` (`id`),
  CONSTRAINT `tipo_categoria_ibfk_2` FOREIGN KEY (`categoria_id`) REFERENCES `categoria` (`id`)
